...
class Experience extends Component {
  render() {
    var link = <a href="https://techtogether.io/" target="_blank">here.</a>
    var resumeLink = <a href={resume} target="_blank">resume</a>
    var code = <a href="https://github.com/oschlepphorst/personal-webpage" target="_blank">code</a> 
    return (
        <div className="experience-page">

          <div className="ttb">
            <img className="tech-together-logo" src={techTogether} alt="TechTogetherLogo"></img>
            <p className="ttb-info">For a year and a half I was on the organizing team for TechTogether Boston, Boston's largest all female, 
            ...
            about TechTogether's mission {link}</p>
          </div>

          <div className="desktop-metal">
            <p className="dm-info">In 2019 I completed a six month software development co-op at Desktop Metal, a metal 3D printing system company 
            ...
            I followed an agile development methodology, and I also worked with other teams to specify requirements.</p>
          ...
          <h3 className="more-stuff">More stuff...</h3>
          <div className="resume-section">
            <p className="resume-info">Check out my {resumeLink} to see more about me in addition to my relevant experience above.</p>
          </div>

          <div className="website-code-section">
            <p>Check out my {code} for this website!</p>
          </div>
